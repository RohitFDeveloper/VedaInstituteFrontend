...
// import './plugins/wow.min.js';
// import './plugins/ajax-contact.js';
        ...
        (n.navigation = function (t, s) {
            ...
            n(t).find('.nav-menus-wrapper').prepend("<span class='nav-menus-wrapper-close-button'>✕</span>"),
                n(t).find('.nav-search').length > 0 &&
                    n(t).find('.nav-search').find('form').prepend("<span class='nav-search-close-button'>âœ•</span>"),
                (u.init = function () {
            ...
            (u.showSubmenu = function (e, i) {
                g() > u.settings.mobileBreakpoint && n(t).find('.nav-search').find('form').slideUp(),
                    'fade' == i
                        ? n(e).children('.nav-submenu').stop(!0, !0).delay(u.settings.showDelayDuration).slideDown(u.settings.showDuration)
                        : n(e).children('.nav-submenu').stop(!0, !0).delay(u.settings.showDelayDuration).slideDown(u.settings.showDuration),
                    n(e).addClass('nav-submenu-open');
            }),
                (u.hideSubmenu = function (e, i) {
                    'fade' == i
                        ? n(e).find('.nav-submenu').stop(!0, !0).delay(u.settings.hideDelayDuration).slideUp(u.settings.hideDuration)
                        : n(e).find('.nav-submenu').stop(!0, !0).delay(u.settings.hideDelayDuration).slideUp(u.settings.hideDuration),
            ...
            (u.showOffcanvas = function () {
                ...
                (u.toggleSearch = function () {
                    'none' == n(t).find('.nav-search').find('form').css('display')
                        ? (n(t).find('.nav-search').find('form').slideDown(), n(t).find('.nav-submenu').fadeOut(200))
            ...
            var m = function () {
                    u.settings.responsive
                        ? (g() <= u.settings.mobileBreakpoint &&
                              ...
                              (n(t).addClass('navigation-portrait').removeClass('navigation-landscape'), D()),
                          g() > u.settings.mobileBreakpoint &&
                              d <= u.settings.mobileBreakpoint &&
                              (n(t).addClass('navigation-landscape').removeClass('navigation-portrait'), k(), p(), u.hideOffcanvas()),
                          (r = g()),
                          (d = g()))
                        : k();
                },
                    ...
                    w(),
                        ...
                        navigator.userAgent.match(/Mobi/i) || navigator.maxTouchPoints > 0 || 'click' == u.settings.submenuTrigger
                            ? n(t)
                                  ...
                                  .on(f, function (i) {
                                      if (
                                          (u.hideSubmenu(n(this).parent('li').siblings('li'), u.settings.effect),
                                          n(this)
                                              .closest('.nav-menu')
                                              .siblings('.nav-menu')
                                              .find('.nav-submenu')
