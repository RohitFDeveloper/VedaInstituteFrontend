...
const courseData = {
    ...
    posterUrl: 'https://reliableacademy.com/assets/images/media/upsc-classes-thane.jpeg',
    title: 'About Course',
        ...
        <>
            ...
            <section className="teacher-details">
                <div className="container">
                    ...
                    <div className="teacher-details-tab">
                        <Tabs id="controlled-tab-example" activeKey={key} onSelect={(k) => setKey(k)} className="mb-3" fill>
                            <Tab
                                eventKey="free"
                                title={
                                    <div className={key == 'free' ? 'courseTab coursesTabActive' : 'courseTab coursesTabNormal'}>
                            ...
                            <Tab
                                eventKey="paid"
                                title={
                                    <div className={key == 'paid' ? 'courseTab coursesTabActive' : 'courseTab coursesTabNormal'}>
